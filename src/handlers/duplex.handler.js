    ...
    send(packet) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (this.status === "CONNECTED") {
                ...
                reject({code: "ERR-CONNECTION-REFUSED", message: "Apollo is not connceted to server. Check internet connection or make sure that you are authenticated to the server."});
            }
        });
    }
