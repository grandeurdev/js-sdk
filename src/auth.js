  ...
  async login(email, password) {
    ...
    if (res.code === "AUTH-ACCOUNT-LOGGEDIN") {
      ...
      if (typeof window !== "undefined") {
        ...
        process.env.TOKEN_KEY == `grandeur-auth-${this.post.config.apiKey}`;
        process.env.TOKEN_VALUE == res.token;
      }
    }
          ...
          confirm: async (verificationCode) => {
            ...
            if (response.code === "AUTH-ACCOUNT-REGISTERED") {
              ...
              if (typeof window !== "undefined") {
                ...
                process.env.TOKEN_KEY == `grandeur-auth-${this.post.config.apiKey}`;
                process.env.TOKEN_VALUE == response.token;
              }
            }
